...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Panel de administración | Steel Balance</title>
  ...
  <body class="skin-red fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="?module=home" class="logo"><b>Steel</b> Balance</a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2021 - <a href="http://facturacionweb.site/">Steel Balance</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
