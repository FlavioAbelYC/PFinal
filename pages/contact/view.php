...
<div class="row">
    ...
    elseif ($_GET['alert'] == 1) { ?>
        <div style="margin-top:25px" class="alert alert-success alert-dismissible" role="alert">
            ...
            <strong><i class="glyphicon glyphicon-alert"></i> !Bien hecho manito!</strong> Tu mensaje ha sido enviado correctamente.
        </div>
    <?php
    } 
    ?>
        <div class="row">
            <div style="padding-right:50px" class="col-lg-8">
                <h3 class="page-header">
                    ...
                    Envíanos un mensaje para obtener mas información
                </h3>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div style="padding: 0 10px;text-align:justify"> 
                            ...
                            <p><i style="margin-right:10px" class="fa fa-map-marker"></i>Alvarez Thomas Mz. X Lote 3. Uchumayo - Arequipa - Arequipa</p>
                            <div style="border: 1px dotted #eee; margin: 10px 0 10px 0"></div>
                            <p><i style="margin-right:10px" class="fa fa-phone"></i>(054) 411137</p>
                            <div style="border: 1px dotted #eee; margin: 10px 0 10px 0"></div>
                            <p><i style="margin-right:10px" class="fa fa-envelope"></i>steelbalance@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
